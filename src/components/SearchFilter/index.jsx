...
const SearchFilter = (props) => {
    ...
    return (
        <>
            <div className='hero position-relative z-index-2' o >    {/* position-relative h-100  */}
                <div className={`container ${styles.md_container}   ${styles.container} `} > {/* absolute-center flex-center flex-column */}
                    ...
                    <div className={` ${styles.find_listing} `}>
                        ...
                        <div className={`${styles.hero_initial_section}`}>{/*  flex-row */}
                            <div className={`${styles.heading} uppercase`}>find</div>{/* uppercase clr-primary f-bold heading-primary */}
                            <div className={` ${styles.scroller} ${styles.listing_types}`}>
                                <div role='filter-list' className={` scroller__inner ${styles.scroller__inner} `}> 
                                    <div className={`active capitalize w-max-content ${styles.active}`}>all </div>{/* capitalize test-blue-border w-max-content */}
                                    <div className={`capitalize w-max-content`}> rooms</div> {/* capitalize test-blue-border w-max-content */}
                                    <div className={` capitalize w-max-content`}>apartment</div> {/* capitalize test-blue-border w-max-content */}
                                    <div className={`capitalize w-max-content`}>cabin</div> {/* capitalize test-blue-border w-max-content */}
                                    <div className={`capitalize w-max-content`}>home stay</div> {/* capitalize test-blue-border w-max-content */}
                                    <div className={`capitalize w-max-content`}>villas</div> {/* capitalize test-blue-border w-max-content */}
                                    <div className={`capitalize w-max-content`}>cottage</div> {/* capitalize test-blue-border w-max-content */}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={`  ${styles.search_bar}  `}>
                            <form className={`${styles._form} `}>
                                <div className={`search-input ${styles.form_input}  ${styles.form_input_location} location`}>
                                    ...
                                    {/* <button className={`${styles.btn_search_location}`}>Which city do you prefer?</button> */}

                                    {/* <LucidIcon className={`${styles.sm_icon}`} name='x' size={24}/> */}
                                ...
                                <div className={`search-input ${styles.form_input} ${styles.form_input_check_in} `} 
                                    ...
                                    {/* <button className={`${styles.btn_date}`}>Add Date</button> */}

                                    {/* <LucidIcon className={`${styles.sm_icon}`} name='calendar-days' size={24}/> */}
                                ...
                                <div className={`search-input ${styles.form_input} ${styles.form_input_guests} `}
                                    onClick={GuestClickHandlar}> {/* guests*/}
                                    <label className='capitalize'>Guests</label>{/* capitalize*/}
                                    <input readOnly 
                                        value={guestCountTxtVal+infantCountTxtVal+petCountTxtVal}
                                        // value={ `${guestCount['adult'] > 0 
                                        //             ?  (guestCount['adult'] + guestCount['children'])+'Guest(s)'
                                        //             :''}${guestCount['infants'] > 0
                                        //                     ?', '+guestCount['infants'] + 'Infant(s)'
                                        //                     :''}${guestCount['pets'] > 0
                                        //                             ?', '+guestCount['pets']+'Pet(s)'
                                        //                             :''}`}

                                    className='guests-input' type='text' placeholder='Add Guests'/>
                                    {/* <button className={`${styles.btn_guests_count}`}>Add Guests</button> */}
                                    {/* <LucidIcon className={`${styles.sm_icon}`} name='users-2' size={24}/> */}                                    
                                ...
                                <div className={`${styles.form_btn_group} `}>
                                    ...
                                    <button className={`${styles.search_btn} ` }>
                                        ...
                                        {/* <LucidIcon className={`${styles.search_icon}`} name='search' size={24}/> */}
